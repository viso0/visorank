-- ============================================================================
-- VisoRank - Complete Supabase Setup & Schema File
-- Copy and run this script in the Supabase SQL Editor (Dashboard > SQL Editor)
-- ============================================================================
...
DROP POLICY IF EXISTS "Public Access to Product Logos" ON storage.objects;
...
DROP POLICY IF EXISTS "Authenticated Users Can Upload Product Logos" ON storage.objects;
...
DROP POLICY IF EXISTS "Founders can update their own products" ON public.products;
...
DROP POLICY IF EXISTS "Founders or admins can delete products" ON public.products;
...
DROP POLICY IF EXISTS "Founders can view click events for their products" ON public.click_events;
...
DROP POLICY IF EXISTS "Authenticated users can create promotions" ON public.promotions;
...
-- ============================================================================
-- 16. Seed Data (Initial Categories & Starter Products)
-- ============================================================================
